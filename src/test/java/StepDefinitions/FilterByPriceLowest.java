...
public class FilterByPriceLowest {
    WebDriver driver;

    @Given("^Open chrome and login with registred account 4$")
    public void Open_chrome_and_login_with_registred_account_4() throws Throwable {
    ...
    public void Select_hotel_check_in_date_check_out_date_then_click_search_now_4() throws Throwable {
    ...
    public void Click_on_price_and_filter_price_from_lowest_to_highest() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 5);
        Thread.sleep(1000);
    ...
    public void user_will_see_hotel_price_displayed_from_lowest_to_highest() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 5);
        Thread.sleep(1000);

        WebElement lower_price= wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"category_data_cont\"]/div[1]/div/div[2]/div[3]/span[1]")));
        Assert.assertTrue(lower_price.isDisplayed());
