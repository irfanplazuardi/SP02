...
import io.cucumber.java.lv.Bet;
...
public class BookByBankWire {
    WebDriver driver;

    @Given("^Open chrome and login with registred account 1$")
    public void Open_chrome_and_login_with_registred_account_1() throws Throwable {
    ...
    public void Select_hotel_check_in_date_check_out_date_then_click_search_now_1() throws Throwable {
    ...
    public void Book_a_room_and_proceed_to_checkout_1() throws Throwable {
    ...
    public void Proceed_for_payment_room_with_bank_wire() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 5);
        ...
        WebElement payment_bank = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("bankwire")));
        Assert.assertTrue(payment_bank.isDisplayed());
        driver.findElement(By.className("bankwire")).click();
        Thread.sleep(1000);

        WebElement bank_wire = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"center_column\"]/form/div")));
        Assert.assertTrue(bank_wire.isDisplayed());
    ...
    public void Confirmation_hotel_room_order_is_complete_1() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 5);

        WebElement order_complete= wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"center_column\"]/div[1]/p[1]")));
