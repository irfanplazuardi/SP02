...
public class FilterByRatingDescending {
    WebDriver driver;

    @Given("^Open chrome and login with registred account 7$")
    public void Open_chrome_and_login_with_registred_account_7() throws Throwable {
    ...
    public void Select_hotel_check_in_date_check_out_date_then_click_search_now_7() throws Throwable {
    ...
    public void Click_on_rating_and_filter_rating_by_desscending() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 5);
        Thread.sleep(1000);
    ...
    public void user_will_see_hotel_rating_displayed_by_descending() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 5);
        Thread.sleep(1000);
