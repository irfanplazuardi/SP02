...
public class BookByCheck {
    WebDriver driver;

    @Given("^Open chrome and login with registered account 2$")
    public void Open_chrome_and_login_with_registered_account_2() throws Throwable {
    ...
    public void Select_hotel_check_in_date_check_out_date_then_click_search_now_2() throws Throwable {
    ...
    public void Book_a_room_and_proceed_to_checkout_2() throws Throwable {
    ...
    public void Proceed_for_payment_room_with_check() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 5);
        Thread.sleep(1000);
        ...
        WebElement payment_bank = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("cheque")));
    ...
    public void Confirmation_hotel_room_order_is_complete_2() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 5);
